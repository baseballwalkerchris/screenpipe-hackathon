...
export default function UserTestPage() {
  ...
  const handleContinue = () => {
    if (currentInstructionIndex < instructionsList.length - 1) {
      // Move to next task description
      setCurrentInstructionIndex((prev) => prev + 1);
      setIsCompleted(false);
      // Don't start task automatically, show description first
      setTaskStarted(false);
    } else {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-white">
      ...
      <div className="flex-1 flex flex-col h-screen">
        <TopBar projectName={projectId} showBackButton onBackClick={handleBackButton} />
        {(!showLandingScreen) && (
          <ProgressBar
            progress={
              showFinalCompletion ? 100 : (currentInstructionIndex + 1) * (100 / instructionsList.length)
            }
          />
        )}
              ...
              <div className="flex-1 pr-8">
                <div className="max-w-2xl">
                  ...
                  <p className="text-gray-600 mb-8">
                    In this user test, you'll be exploring a travel planning interface
                    and completing {instructionsList.length} tasks. We'll record your
                    interactions to help improve the user experience.
                  </p>
                ...
                <div className="bg-white rounded-lg p-6 mb-8 flex items-center border border-gray-200">
                  <div className="flex items-center gap-6">
                    ...
                    <div className="text-gray-600 text-sm">
                      Your compensation will be sent<br />
              ...
              <div className="flex-1 p-8 flex items-center">
                <div className="max-w-2xl">
                  <h1 className="text-3xl font-semibold mb-6">
                    Great job! You completed Task {currentInstructionIndex + 1}
                  </h1>
                  <Button
              ...
              <div className="flex-1 p-8 flex items-center">
                <div className="max-w-2xl">
                  <h2 className="text-2xl font-semibold mb-4">
                    Task {currentInstructionIndex + 1} of {instructionsList.length}
                  </h2>
                  <h1 className="text-3xl font-semibold mb-6">
                    {currentInstruction.title}
                  </h1>
