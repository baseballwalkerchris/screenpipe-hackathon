...
export default function SharePage() {
  ...
  const permissionOptions = {
    ...
    "anyone": {
      icon: Globe,
      title: "Anyone",
      description: "Your project will be publicly available for users on Sensus"
    }
  };

  const selectedOption = permissionOptions[permissionType as keyof typeof permissionOptions];
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-500">
                          Only people with your testing link can test your project
                        </div>
                      </div>
                    </div>
                  </SelectItem>
